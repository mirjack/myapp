...
function readCachedNativeBrandingContactsSync() {
...
export async function clearCachedNativeBrandingContacts() {
  contactsMemoryCache = null;
  try {
    await SecureStore.deleteItemAsync(BRANDING_CONTACTS_KEY);
  } catch {
    // no-op
  }
}
