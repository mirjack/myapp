...
export const LEGAL_URLS = {
  privacy: process.env.EXPO_PUBLIC_PRIVACY_POLICY_URL || Constants?.expoConfig?.extra?.privacyPolicyUrl || "",
  terms: process.env.EXPO_PUBLIC_TERMS_URL || Constants?.expoConfig?.extra?.termsUrl || "",
};
